...
$userId = $_SESSION['user_id'] ?? 0; // Check for logged-in user
$cartItems = [];
...
.dark-cart-section h2 {
    color: #000000; /* Slightly vibrant color for headings */
    margin-bottom: 20px;
    font-family: 'Poppins', sans-serif; /* Set font to Poppins */
}

.dark-cart-section .cart-item {
    border-bottom: 1px solid #34495E; /* Separator */
    padding-bottom: 15px;
    margin-bottom: 15px;
}

.dark-cart-section .cart-item:last-child {
    border: none; /* Remove separator for the last item */
}

.dark-cart-section .item-info img {
    border-radius: 4px; /* Rounded corners for images */
    margin-right: 15px;
}

.dark-cart-section .item-info h5, .dark-cart-section .item-info p {
    margin: 0;
    padding: 5px 0;
    color: #000000;
    font-family: 'Poppins', sans-serif; /* Set font to Poppins */
...
.dark-cart-section .form-control {
    color: #000000;
...
.dark-cart-section .btn {
    border: none;
    margin-top: 10px;
    font-family: 'Poppins', sans-serif; /* Set font to Poppins */
}

.dark-cart-section .btn-info {
    background-color: #18BC9C;
}

.dark-cart-section .btn-danger {
    background-color: #E74C3C;
}

.dark-cart-section .btn-primary {
    background-color: #3498DB;
}

.dark-cart-section .cart-total h4 {
    border-top: 1px solid #34495E; /* Separator for total */
    padding-top: 15px;
    margin-top: 20px;
    font-family: 'Poppins', sans-serif; /* Set font to Poppins */
}

.dark-cart-section .checkout button {
...
@media (max-width: 768px) {
    .dark-cart-section .item-info, .dark-cart-section .item-actions {
    ...
    .dark-cart-section .item-actions {
        margin-top: 15px;
    }
}
  ...
  <div class="container mt-6">
        ...
        <div class="cart-item d-flex justify-content-between align-items-center mb-3">
            <div class="item-info d-flex align-items-center">
                <div class="ms-3">
                    ...
                    <form action="PHP Files/updateCart.php" method="POST" class="d-inline">
                        <input type="hidden" name="product_id" value="<?= htmlspecialchars($item['product_id']) ?>">
                        <input type="number" name="quantity" value="<?= htmlspecialchars($item['quantity']) ?>" min="1" class="form-control d-inline-block" style="width: 80px;">
            ...
            <div class="item-actions d-flex flex-column align-items-center">
                <!-- Item Total -->
                <strong>Total: $<?= htmlspecialchars($item['price'] * $item['quantity']) ?></strong>
                <!-- Delete Product Form -->
                <form action="PHP Files/deleteFromCart.php" method="POST">
                    <input type="hidden" name="product_id" value="<?= htmlspecialchars($item['product_id']) ?>">
    ...
    <div class="cart-summary mt-4">
        <div class="cart-total">
            <h4>Total Amount: $<?= array_sum(array_map(function($item) { return $item['price'] * $item['quantity']; }, $cartItems)); ?></h4>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Check if the status and message parameters exist
    if (params.status && params.message) {
        ...
        // Optional: Remove the query parameters from the URL
