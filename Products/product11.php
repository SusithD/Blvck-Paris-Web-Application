...
<body>
    ...
    <div class="product-image">
        <img src="../images/product11.jpg" alt="Blvck Sweater Black">
    </div>
    <div class="product-details">
        <h1>Blvck Sweater Black</h1>
        ...
        <form method="POST" action="../PHP Files/addToCart.php">
            ...
            <input type="hidden" name="product_id" value="131"> <!-- Unique Product ID -->
            <input type="hidden" name="product_name" value="Blvck Sweater Black">
            <input type="hidden" name="price" value="47800">
            <button type="submit" name="add_to_cart" class="add-to-cart-btn">Add to Cart</button>
        </form>
        <div class="product-description">
            <h3>Description</h3>
            <p>Detailed description about Blvck Sweater Black.</p>
        </div>
        <div class="product-shipping-returns">
            <h3>Shipping & Returns</h3>
            <p>Detailed shipping and return policy.</p>
        </div>
