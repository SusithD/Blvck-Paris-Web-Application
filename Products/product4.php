...
<body>
    ...
    <div class="product-image">
        <img src="../images/product4.jpg" alt="Whte Evil Twin Teddy Bear Hoodie">
    </div>
    <div class="product-details">
        <h1>Whte Evil Twin Teddy Bear Hoodie</h1>
        ...
        <form method="POST" action="../PHP Files/addToCart.php">
            ...
            <input type="hidden" name="product_id" value="126"> <!-- Unique Product ID -->
            <input type="hidden" name="product_name" value="Whte Evil Twin Teddy Bear Hoodie">
            <input type="hidden" name="price" value="47800">
            <button type="submit" name="add_to_cart" class="add-to-cart-btn">Add to Cart</button>
        </form>
        <div class="product-description">
            <h3>Description</h3>
            <p>Delve into the playful and mysterious with the Whte Evil Twin Teddy Bear Hoodie. This unique piece combines comfort with an edgy design, perfect for those who love to stand out.</p>
        </div>
        <div class="product-shipping-returns">
            <h3>Shipping & Returns</h3>
            <p>Detailed shipping and return policy information...</p>
        </div>
        <div class="product-offers">
            <h3>Multiple Offers</h3>
            <ul>
                <li>Exclusive offers listed here...</li>
            </ul>
        </div>
    </div>
</div>
