...
<body>
    ...
    <div class="product-image">
        <img src="../images/product2.jpg" alt="Death Kiss Sweater">
    </div>
    <div class="product-details">
        <h1>Blvck X Whte' Death Kiss Sweater</h1>
        ...
        <form method="POST" action="../PHP Files/addToCart.php">
            ...
            <input type="hidden" name="product_id" value="124"> <!-- Unique Product ID -->
            <input type="hidden" name="product_name" value="Blvck X Whte' Death Kiss Sweater">
        ...
        <div class="product-description">
            ...
            <p>Introducing Shades of Black, our latest collection of essentials, available in three different
                shades. The Death Kiss Sweater boasts a unique design with high-quality material.</p>
        </div>
        <div class="product-shipping-returns">
            <h3>Shipping & Returns</h3>
            <p>Enjoy free standard shipping on all orders over $50. Express shipping is also available for an
                additional fee. Items can be returned or exchanged within 30 days of delivery.</p>
        </div>
