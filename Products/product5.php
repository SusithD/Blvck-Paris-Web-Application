...
<body>
    ...
    <div class="product-image">
        <img src="../images/product5.jpg" alt="Whte Angel Hoodie">
    </div>
    <div class="product-details">
        <h1>Whte Angel Hoodie</h1>
        ...
        <form method="POST" action="../PHP Files/addToCart.php">
            ...
            <input type="hidden" name="product_id" value="127"> <!-- Unique Product ID -->
            <input type="hidden" name="product_name" value="Whte Angel Hoodie">
            <input type="hidden" name="price" value="47800">
            <button type="submit" name="add_to_cart" class="add-to-cart-btn">Add to Cart</button>
        </form>
        <div class="product-description">
            <h3>Description</h3>
            <p>Embrace the ethereal with the Whte Angel Hoodie, featuring a celestial design that combines comfort and style for a look that's both angelic and edgy.</p>
        </div>
