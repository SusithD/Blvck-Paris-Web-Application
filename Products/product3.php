...
<body>
    ...
    <div class="product-image">
        <img src="../images/product3.jpg" alt="Whte Signature Hoodie">
    </div>
    <div class="product-details">
        <h1>Whte Signature Hoodie</h1>
        ...
        <form method="POST" action="../PHP Files/addToCart.php">
            ...
            <input type="hidden" name="product_id" value="125"> <!-- Unique Product ID -->
            <input type="hidden" name="product_name" value="Whte Signature Hoodie">
            <input type="hidden" name="price" value="47800">
            <button type="submit" name="add_to_cart" class="add-to-cart-btn">Add to Cart</button>
        </form>
        <div class="product-description">
            <h3>Description</h3>
            <p>Experience the luxury of simplicity with our Whte Signature Hoodie. Crafted for comfort and style, it features a minimalist design accentuated by the signature Blvck Paris logo.</p>
        </div>
