...
<body>
    ...
    <div class="product-container">
        <div class="product-image">
            <img src="../images/product12.jpg" alt="Black Hoodie">
        </div>
        <div class="product-details">
            <h1>Blvck Signature Dress</h1>
            ...
            <input type="hidden" name="product_id" value="132"> <!-- Unique Product ID -->
            <input type="hidden" name="product_name" value="Blvck Signature Dress">
            ...
            <!-- Add more product details like description, shipping & returns -->
        </div>
    </div>
