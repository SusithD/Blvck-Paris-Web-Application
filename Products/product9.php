...
<body>
    ...
    <div class="product-image">
        <img src="../images/product9.jpg" alt="Charcoal Hoodie">
    </div>
    <div class="product-details">
        <h1>Charcoal Hoodie</h1>
        ...
        <form method="POST" action="../PHP Files/addToCart.php">
            ...
            <input type="hidden" name="product_id" value="129"> <!-- Unique Product ID -->
            <input type="hidden" name="product_name" value="Charcoal Hoodie">
            <input type="hidden" name="price" value="47800">
            <button type="submit" name="add_to_cart" class="add-to-cart-btn">Add to Cart</button>
        </form>
        <div class="product-description">
            <h3>Description</h3>
            <p>Discover the Charcoal Hoodie, blending sleek design with premium warmth. Perfect for layering, this hoodie is a versatile addition to your wardrobe, featuring a minimalistic design accented by our signature logo.</p>
        </div>
