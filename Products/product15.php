...
<body>
    ...
    <div class="product-image">
        <img src="../images/product15.jpg" alt="Blvck Hoodie 'Ash'">
    </div>
    <div class="product-details">
        <h1>Blvck Hoodie "Ash"</h1>
        ...
        <form method="POST" action="../PHP Files/addToCart.php">
            ...
            <input type="hidden" name="product_name" value="Blvck Hoodie 'Ash'">
            <input type="hidden" name="price" value="47800">
            <button type="submit" name="add_to_cart" class="add-to-cart-btn">Add to Cart</button>
        </form>
        <div class="product-description">
            <h3>Description</h3>
            <p>Delve into the essence of sophistication with our 'Ash' edition, featuring a sleek design and premium fabric that sets a new standard for casual luxury.</p>
        </div>
        <div class="product-shipping-returns">
            <h3>Shipping & Returns</h3>
            <p>Enjoy complimentary standard shipping on orders over $50. Express delivery available at an extra cost. Returns and exchanges accepted within 30 days of purchase, provided items are in original condition.</p>
        </div>
        <div class="product-offers">
            <h3>Multiple Offers</h3>
            <ul>
                <li>Earn 6% rebate with crypto.com Pay</li>
                <li>Receive a complimentary t-shirt with every hoodie purchase</li>
                <li>Enjoy a 10% discount on your first order when you sign up for our newsletter</li>
            </ul>
        </div>
    </div>
</div>
