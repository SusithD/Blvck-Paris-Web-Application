...
<body>
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                ...
                <div class="offcanvas-body justify-content-between">
                    ...
                    <ul class="navbar-nav menu-list list-unstyled d-flex gap-md-3 ps-lg-5 mb-0">
                        ...
                        <li class="nav-item">
                            <a href="https://templatesjungle.gumroad.com/l/uniclub-t-shirt-bootstrap5-eCommerce-website-template"
                                class="nav-link mx-2" target="_blank">GET PRO</a>
                        </li>
                    </ul>
    ...
    <div class="product-container">
        <div class="product-image">
            <img src="../images/product1.jpg" alt="Black Hoodie">
        </div>
        <div class="product-details">
            <h1>Blvck Hoodie 'Black'</h1>
            ...
            <form method="POST" action="../PHP Files/addToCart.php">
                ...
                <input type="hidden" name="product_id" value="123"> <!-- Example Product ID -->
                <input type="hidden" name="product_name" value="Blvck Hoodie 'Black'">
            ...
            <div class="product-description">
                <h3>Description</h3>
                <p>Introducing Shades of Black, our latest collection of essentials, available in three different
                    shades. The Black
                    Hoodie 'Black' boasts a light black tone and an oversized fit. The back features a bold 'Blvck
                    Paris' logo in UV
                    print and the front features a subtle logo in the chest in UV rubber print.</p>
            </div>

            <!-- Shipping & Returns -->
            <div class="product-shipping-returns">
                <h3>Shipping & Returns</h3>
                <p>Enjoy free standard shipping on all orders over $50. Express shipping is also available for an
                    additional fee.
                    Items can be returned or exchanged within 30 days of delivery. Please note that all returned items
                    must be in
                    new and unused condition with all original tags attached.</p>
            </div>
            ...
            <div class="product-offers">
                ...
                <ul>
                    ...
                    <li>Get a free t-shirt with every hoodie purchase</li>
